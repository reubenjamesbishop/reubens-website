...
const charactersList = [
	{
		...
		content:
			"I did a Graduate Certficate in Data Science at while working full-time. I've learned about advanced statistics concepts, advanced SQL concepts and business intelligence with Tableau.",
	},
